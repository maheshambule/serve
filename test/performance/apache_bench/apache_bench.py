...
class ApacheBenchExecutor(ScenarioExecutor, WidgetProvider, HavingInstallableTools, SelfDiagnosable):
    """
    ...
    def prepare(self):
        super(ApacheBenchExecutor, self).prepare()
